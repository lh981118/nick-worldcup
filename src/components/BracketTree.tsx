...
export function BracketTree({ result }: Props) {
  ...
  const stages = [
    { key: 'r32', label: stageDisplayName('r32', locale), rows: data.r32 },
    { key: 'r16', label: stageDisplayName('r16', locale), rows: data.r16 },
    { key: 'qf', label: stageDisplayName('qf', locale), rows: data.qf },
    { key: 'sf', label: stageDisplayName('sf', locale), rows: data.sf },
    { key: 'final', label: stageDisplayName('final', locale), rows: data.final },
    { key: 'champ', label: stageDisplayName('champ', locale), rows: data.champ },
  ];
